    ...
    return (
        <div className='w-full mt-0 bg-white'>
            ...
            <div className='w-[76%] mx-auto'>
                <p className='text-[15px] font-sans flex items-center'>Kết quả tìm kiếm cho <strong className='ml-2'>"{keyword}"</strong></p>
            </div>
            <div className='list-product w-[76%] mx-auto mt-6 mb-[40px] grid grid-cols-5 gap-6'>
                {productSearch?.length > 0 ? (
                    ...
                    <p className='text-gray-500 text-[15px] mt-4'>Không tìm thấy sản phẩm phù hợp.</p>  
                )}
            </div>
        </div>
    )
