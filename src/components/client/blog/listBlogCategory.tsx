...
const ListBlogCategory = () => {
    ...
    const { data: blogRes } = useList({
        resource: `/posts/client/category/${slug}`,
    });
            ...
            <div className="bg-white p-4 shadow-sm rounded-md">
                ...
                <ul className="mt-4 space-y-4">
                    {latestPosts.map((post: any) => (
                        <Link to={`/detailBlog/${post.slug}`} key={post._id} className="flex gap-3 cursor-pointer">
            ...
            <div className="w-[76%]">
                ...
                <Link to={`/detailBlog/${post.slug}`} key={post._id}>
                    ...
                    <div className="p-4">
                        ...
                        <Link to={`/blog/${post.slug}`} className="text-blue-600 hover:underline">Xem thêm »</Link>
                        </div>
                    </div>
                    </div>
                </Link>
