...
const AddAddressesAdmin = ({ isOpen, onClose, userId }: any) => {
    const [showModal, setShowModal] = useState<"addAddressAdmin" | null>("addAddressAdmin");
    ...
    const { mutate } = useCreate(
        { 
            resource: `/addresses/user/${userId}` 
        }
    );
    ...
    const handleFinish = (values: any) => {
        ...
        mutate(values, {
            ...
            onError: (error) => {
                ...
                message.error("Thêm địa chỉ mới thất bại. Vui lòng thử lại.");
            },
           onSettled: () => {
                setLoading(false);
            },
                    ...
                    {showModal === "addAddressAdmin" && (
                        <div className="flex w-[95%] justify-center">
                            ...
                            >
                                ...
                                <Button loading={loading} icon={<PlusOutlined />} type="primary" htmlType="submit" style={{ height: 40 }} className="w-40">
                                    Thêm địa chỉ
                                </Button>
                                </div>
                            </Form>
...
export default AddAddressesAdmin;
